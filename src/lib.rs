...
//! host-to-IP mappings. It's built on the hyper framework for high performance.
//!
//! ## Modules
//!
...
//! - [`proxy`]: The main hyper-based proxy implementation
...
//! use host_proxy::proxy::ProxyServer;
//!
//! // Load configuration
